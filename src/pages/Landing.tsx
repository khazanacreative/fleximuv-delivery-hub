      ...
      <section className="py-16 md:py-24 bg-fleximuv-50 relative">
        <div className="container mx-auto px-4 grid md:grid-cols-2 gap-8 items-center">
          <div className="space-y-6">
            ...
            Helping small and medium enterprises manage orders and deliveries easily. All communications are integrated with WhatsApp, and the app charges a low fee of only 1,000 rupiahs per transaction.
            </p>
